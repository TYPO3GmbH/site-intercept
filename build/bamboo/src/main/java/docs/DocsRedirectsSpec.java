...
@BambooSpec
public class DocsRedirectsSpec {
    ...
    public Plan plan() {
        final Plan plan = new Plan(new Project()
            ...
            "Docs - Redirects",
            new BambooKey("DRD"))
            .oid(new BambooOid("18cfizsjs308x"))
    ...
    public PlanPermissions planPermission() {
        final PlanPermissions planPermission = new PlanPermissions(new PlanIdentifier("CORE", "DRD"))
            .permissions(new Permissions()
                    .userPermissions("frank.naegler", PermissionType.ADMIN, PermissionType.VIEW, PermissionType.CLONE, PermissionType.BUILD, PermissionType.EDIT)
