...
@BambooSpec
public class DocsRenderingFluidVHmasterSpec {
    ...
    public Plan plan() {
        final Plan plan = new Plan(new Project()
            ...
            "Docs - Rendering Fluid VH master",
            new BambooKey("DRFVM"))
            .oid(new BambooOid("18cfizsjs33eq"))
    ...
    public PlanPermissions planPermission() {
        final PlanPermissions planPermission = new PlanPermissions(new PlanIdentifier("CORE", "DRFVM"))
            .permissions(new Permissions()
                    .userPermissions("anja.leichsenring", PermissionType.ADMIN, PermissionType.VIEW, PermissionType.CLONE, PermissionType.BUILD, PermissionType.EDIT)
