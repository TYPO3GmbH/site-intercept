...
@BambooSpec
public class DocsRenderingSurf20Spec {
    ...
    public Plan plan() {
        final Plan plan = new Plan(new Project()
            ...
            "Docs - Rendering Surf 2.0 beta11",
            new BambooKey("DRS"))
            .oid(new BambooOid("18cfizsjs311i"))
    ...
    public PlanPermissions planPermission() {
        final PlanPermissions planPermission = new PlanPermissions(new PlanIdentifier("CORE", "DRS"))
    ...
    public static void main(String... argv) {
        ...
        final DocsRenderingSurf20Spec planSpec = new DocsRenderingSurf20Spec();
