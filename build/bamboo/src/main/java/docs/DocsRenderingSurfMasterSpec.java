...
@BambooSpec
public class DocsRenderingSurfMasterSpec {
    ...
    public Plan plan() {
        final Plan plan = new Plan(new Project()
            ...
            "Docs - Rendering Surf master",
            new BambooKey("DRSM"))
            .oid(new BambooOid("18cfizsjs311n"))
    ...
    public PlanPermissions planPermission() {
        final PlanPermissions planPermission = new PlanPermissions(new PlanIdentifier("CORE", "DRSM"))
