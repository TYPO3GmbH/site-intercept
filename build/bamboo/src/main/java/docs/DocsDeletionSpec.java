...
public class DocsDeletionSpec {
    ...
    public Plan plan() {
        final Plan plan = new Plan(new Project()
            ...
            "Docs - Deletion",
            new BambooKey("DDEL"))
            .oid(new BambooOid("18cfizsjs311g"))
    ...
    public PlanPermissions planPermission() {
        final PlanPermissions planPermission = new PlanPermissions(new PlanIdentifier("CORE", "DDEL"))
            .permissions(new Permissions()
                    .userPermissions("a.fernandez", PermissionType.EDIT, PermissionType.VIEW, PermissionType.ADMIN, PermissionType.CLONE, PermissionType.BUILD)
                    .userPermissions("christian.kuhn", PermissionType.CLONE, PermissionType.EDIT, PermissionType.ADMIN, PermissionType.BUILD, PermissionType.VIEW)
                    .userPermissions("jurian.janssen", PermissionType.CLONE, PermissionType.BUILD, PermissionType.VIEW, PermissionType.EDIT)
