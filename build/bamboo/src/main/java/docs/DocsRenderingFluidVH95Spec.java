...
@BambooSpec
public class DocsRenderingFluidVH95Spec extends AbstractFluidVHSpec {
    private static String version = "9.5";
    private static String planName = "Docs - Rendering Fluid VH 9.5";
    private static String planKey = "DRF";
