...
class WebHookServiceTest extends TestCase
{
    ...
    public static function createPushEventDataProvider(): array
    {
        return [
    ...
    public function dataCreatePushEventReturnsValidPushEventObject(Request $request, PushEvent $pushEvent): void
    {
        ...
        self::assertSame($pushEvent->getVersionString(), $createdPushEvent[0]->getVersionString());
        self::assertSame($pushEvent->getRepositoryUrl(), $createdPushEvent[0]->getRepositoryUrl());
        self::assertSame($pushEvent->getUrlToComposerFile(), $createdPushEvent[0]->getUrlToComposerFile());
    }

    public static function createPushEventsDataProvider(): array
    {
        return [
    ...
    {
        $createdPushEvent = $this->subject->createPushEvent($request);
        self::assertSame($pushEvents[0]->getVersionString(), $createdPushEvent[0]->getVersionString());
        self::assertSame($pushEvents[0]->getRepositoryUrl(), $createdPushEvent[0]->getRepositoryUrl());
        self::assertSame($pushEvents[0]->getUrlToComposerFile(), $createdPushEvent[0]->getUrlToComposerFile());

        self::assertSame($pushEvents[1]->getVersionString(), $createdPushEvent[1]->getVersionString());
        self::assertSame($pushEvents[1]->getRepositoryUrl(), $createdPushEvent[1]->getRepositoryUrl());
        self::assertSame($pushEvents[1]->getUrlToComposerFile(), $createdPushEvent[1]->getUrlToComposerFile());
    }

    public static function createPushEventsWithDocFiles(): array
    {
        return [
            'File added' => [
