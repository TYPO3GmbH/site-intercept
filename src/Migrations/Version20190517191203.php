 ...
 * @codeCoverageIgnore
 */
final class Version20190517191203 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , target_branch_directory VARCHAR(255) NOT NULL COLLATE BINARY, type_long VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, type_short VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, build_key INTEGER DEFAULT 0 NOT NULL, public_composer_json_url VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, vendor VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, name VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, status INTEGER DEFAULT 0 NOT NULL, package_type VARCHAR(255) NOT NULL, minimum_typo_version VARCHAR(255) DEFAULT \'\' NOT NULL, maximum_typo_version VARCHAR(255) DEFAULT \'\' NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , last_rendered_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL --(DC2Type:datetime)
        , target_branch_directory VARCHAR(255) NOT NULL, type_long VARCHAR(255) DEFAULT \'\' NOT NULL, type_short VARCHAR(255) DEFAULT \'\' NOT NULL, build_key INTEGER DEFAULT 0 NOT NULL, package_type VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, status VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY)');
