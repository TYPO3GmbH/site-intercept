...
final class Version20190517192559 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , target_branch_directory VARCHAR(255) NOT NULL COLLATE BINARY, type_long VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, type_short VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, status INTEGER DEFAULT 0 NOT NULL, build_key VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, public_composer_json_url VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, vendor VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, name VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, package_type VARCHAR(255) NOT NULL, minimum_typo_version VARCHAR(20) DEFAULT \'\' NOT NULL, maximum_typo_version VARCHAR(20) DEFAULT \'\' NOT NULL)');
