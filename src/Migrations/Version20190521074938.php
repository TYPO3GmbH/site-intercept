...
final class Version20190521074938 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__documentation_jar AS SELECT id, repository_url, package_name, branch, created_at, last_rendered_at, target_branch_directory, type_long, type_short, public_composer_json_url, vendor, name, status, build_key, package_type, minimum_typo_version, maximum_typo_version FROM documentation_jar');
        ...
        , target_branch_directory VARCHAR(255) NOT NULL COLLATE BINARY, type_long VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, type_short VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, public_composer_json_url VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, vendor VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, name VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, status INTEGER DEFAULT 0 NOT NULL, build_key VARCHAR(255) DEFAULT \'\' NOT NULL, package_type VARCHAR(255) NOT NULL, extension_key VARCHAR(255), minimum_typo_version VARCHAR(20) DEFAULT \'\' NOT NULL, maximum_typo_version VARCHAR(20) DEFAULT \'\' NOT NULL)');
        $this->addSql('INSERT INTO documentation_jar (id, repository_url, package_name, branch, created_at, last_rendered_at, target_branch_directory, type_long, type_short, public_composer_json_url, vendor, name, status, build_key, package_type, minimum_typo_version, maximum_typo_version) SELECT id, repository_url, package_name, branch, created_at, last_rendered_at, target_branch_directory, type_long, type_short, public_composer_json_url, vendor, name, status, build_key, package_type, minimum_typo_version, maximum_typo_version FROM __temp__documentation_jar');
