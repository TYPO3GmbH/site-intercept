 ...
 * @codeCoverageIgnore
 */
final class Version20190517082253 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , target_branch_directory VARCHAR(255) NOT NULL COLLATE BINARY, type_long VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, type_short VARCHAR(255) DEFAULT \'\' NOT NULL COLLATE BINARY, public_composer_json_url VARCHAR(255) DEFAULT \'\' NOT NULL, vendor VARCHAR(255) DEFAULT \'\' NOT NULL, name VARCHAR(255) DEFAULT \'\' NOT NULL, minimum_typo_version VARCHAR(255) DEFAULT \'\' NOT NULL, maximum_typo_version VARCHAR(255) DEFAULT \'\' NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , last_rendered_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL --(DC2Type:datetime)
        , target_branch_directory VARCHAR(255) NOT NULL, type_long VARCHAR(255) DEFAULT \'\' NOT NULL, type_short VARCHAR(255) DEFAULT \'\' NOT NULL, status INTEGER DEFAULT 0 NOT NULL)');
        $this->addSql('INSERT INTO documentation_jar (id, repository_url, package_name, branch, created_at, last_rendered_at, target_branch_directory, type_long, type_short) SELECT id, repository_url, package_name, branch, created_at, last_rendered_at, target_branch_directory, type_long, type_short FROM __temp__documentation_jar');
        $this->addSql('DROP TABLE __temp__documentation_jar');
    }
}
